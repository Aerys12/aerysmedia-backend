...
from gallery.views import create_gallery_view, gallery_view, galleries_list_view, gallery_update_view, delete_gallery_view, image_upload_view
...
urlpatterns = [
    ...
    path('<int:gallery_id>/images/upload/', image_upload_view.ImageUploadView.as_view(), name='image-upload'),
]